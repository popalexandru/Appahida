...
class ExercicesListAdapter(private val listener : FavClickListener, private val context : Context) : ListAdapter<ExerciseToAdd, ExercicesListAdapter.CakeViewHolder>(
    DiffCallback()
){
